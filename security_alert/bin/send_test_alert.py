...
ALERT_TEMPLATES = {
    '001': {
        ...
        'emoji': '⚙️',
        'color': '#FFA500',
        'sample': {'devname': 'FGT-HQ-01', 'user': 'admin', 'action': 'edit', 'path': 'firewall policy 101'}
    },
    '002': {
        'name': 'VPN Tunnel Down',
        'emoji': '🔴',
        'color': '#FF0000',
        'sample': {'devname': 'FGT-BR-01', 'tunnel': 'HQ-to-Branch', 'peer': '203.0.113.1', 'reason': 'peer timeout'}
    },
    '003': {
        'name': 'VPN Tunnel Up',
        'emoji': '🟢',
        'color': '#00FF00',
        'sample': {'devname': 'FGT-BR-01', 'tunnel': 'HQ-to-Branch', 'peer': '203.0.113.1'}
    },
    '006': {
        'name': 'CPU/Memory Anomaly',
        'emoji': '📊',
        'color': '#FF6600',
        'sample': {'devname': 'FGT-DC-01', 'cpu': '92%', 'memory': '87%', 'threshold': '80%'}
    },
    '007': {
    ...
    '008': {
        ...
        'emoji': '🔄',
        'color': '#0066FF',
        'sample': {'devname': 'FGT-HQ-01', 'old_state': 'standby', 'new_state': 'active', 'reason': 'failover'}
    },
    '010': {
        'name': 'Resource Limit',
        'emoji': '⚠️',
        'color': '#FFCC00',
        'sample': {'devname': 'FGT-HQ-01', 'resource': 'session', 'current': '980000', 'limit': '1000000'}
    },
    '011': {
        'name': 'Admin Login Failed',
        'emoji': '🚫',
        'color': '#FF0000',
        'sample': {'devname': 'FGT-HQ-01', 'user': 'admin', 'srcip': '192.168.1.100', 'reason': 'invalid password', 'attempts': '5'}
    },
    '012': {
        'name': 'Interface Down',
        'emoji': '🔴',
    ...
    '013': {
        ...
        'emoji': '🚨',
        'color': '#FF0000',
        'sample': {'devname': 'FGT-HQ-01', 'srcip': '45.33.32.156', 'attempts': '50', 'timespan': '5 minutes'}
    },
    '015': {
        'name': 'Abnormal Traffic Spike',
        'emoji': '📈',
        'color': '#FF6600',
        'sample': {'devname': 'FGT-DC-01', 'interface': 'wan1', 'current_mbps': '950', 'baseline_mbps': '200'}
    },
    '016': {
        'name': 'System Reboot',
        'emoji': '🔄',
        'color': '#0066FF',
        'sample': {'devname': 'FGT-HQ-01', 'reason': 'firmware upgrade', 'uptime_before': '45 days'}
    },
    '017': {
        'name': 'License Expiry Warning',
        'emoji': '⏰',
        'color': '#FFCC00',
        'sample': {'devname': 'FGT-HQ-01', 'license': 'FortiCare Support', 'expires_in': '7 days', 'expiry_date': '2026-02-11'}
    }
}
...
def build_block_kit(alert_id, template):
    ...
    blocks = [
        {
            'type': 'header',
            'text': {'type': 'plain_text', 'text': f"{template['emoji']} [{alert_id}] {template['name']} (TEST)", 'emoji': True}
        },
        {
            'type': 'section',
            'fields': fields[:4]
    ...
    blocks.append({
        'type': 'context',
        'elements': [{'type': 'mrkdwn', 'text': f'🧪 *TEST ALERT* | {now} | Splunk Security Alert System'}]
    })
